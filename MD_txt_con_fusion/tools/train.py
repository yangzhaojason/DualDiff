...
def main(cfg: DictConfig):
    ...
    # datasets
    if not cfg.save_model_only:
        train_dataset = build_dataset(
            OmegaConf.to_container(cfg.dataset.data.train, resolve=True)
        )
    else:
        from magicdrive.dataset.dataset_wrapper import FolderSetWrapper
        train_dataset = FolderSetWrapper('/opt/data/private/aigc/MagicDrive_occ_token/demo/data')
